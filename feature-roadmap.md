...
- [ ] rework cognitive architecture to have a generic thought graph and add the following "cognition"-types (aka "mental states"): memory/value/intention/objective/goal/task/value/belief/fact/skill?  
...
- [ ] Rework the core architecture to support arbitrarily many "thought processes" (subscribe to thought-stream, think, optionally write back into thought stream, loop) and add new Thought Processes:  
      * **Reflection & Action generator:** Separate action-generator from reflection-generator (i.e. rework the 4phase thought-generator)?  
      ...
      * **skills czar** \- does skill distillation based on recent experience  
      * **values & beliefs czar**: maintains the values & beliefs in the values table of cognitive architecture  
